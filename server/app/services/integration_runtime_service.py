...
from app.db.models import Agent, Intent, IntegrationContractVersion, IntegrationIdentity, Principal
from app.domain.decision.source import normalize_source
from app.services import enforcement_binding_service, intent_service
...
class AdapterReplayDetectedError(Exception):
    ...
    same authenticated request again" -- this is not business-operation
    idempotency (Phase 3, not built here)."""
