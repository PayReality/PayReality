...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "Here, the AP Invoice Agent reported directly -- no Trusted Adapter, a simpler path PayReality still fully supports. Within its delegated authority, the payment is authorized immediately: Allow. PayReality isn't here to block AI -- it's here to make sure only what's actually authorized goes through.",
  },
];
