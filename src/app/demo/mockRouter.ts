...
on("POST", `${POLICY_SIMULATION}/:key/batch`, ({ params }) => {
  ...
  return {
    ...
    cannot_simulate: 0,
    sample_rows: [
      { row_number: 1, principal: "David Okonkwo", action: "vendor_payment", decision: "ALLOW", error: null, limitation: null },
      { row_number: 2, principal: "David Okonkwo", action: "vendor_payment", decision: "ALLOW", error: null, limitation: null },
      { row_number: 3, principal: "David Okonkwo", action: "vendor_payment", decision: "HUMAN_REVIEW", error: null, limitation: null },
      { row_number: 4, principal: "David Okonkwo", action: "vendor_payment", decision: "ALLOW", error: null, limitation: null },
      { row_number: 5, principal: "David Okonkwo", action: "vendor_payment", decision: "ALLOW", error: null, limitation: null },
    ],
